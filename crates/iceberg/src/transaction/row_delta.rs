...
// Source: https://github.com/apache/iceberg-rust/pull/2203 (open, not yet merged).
// The add_delete_files() stub is enabled here using delete-manifest infrastructure
// from https://github.com/apache/iceberg-rust/pull/2367 (open, not yet merged).
...
mod tests {
    ...
    // NOTE: Disabled — add_delete_files() is enabled in this fork via PR #2367
    // infrastructure. When PR #2203 merges upstream and removes the FeatureUnsupported
    // guard, this test will need to be removed or replaced with an end-to-end delete test.
    // #[tokio::test]
